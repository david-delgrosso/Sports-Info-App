# Generated by Django 3.2.15 on 2022-12-09 15:07
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('SportsApp', '0013_nbahistoricalschedule'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('away_team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='away_team_2017', to='SportsApp.nbateam')),
                ('home_team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='home_team_2017', to='SportsApp.nbateam')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('away_opp_blocks_pg', models.FloatField(default=0.0)),
                ('away_opp_plusMinus_pg', models.FloatField(default=0.0)),
                ('away_team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='away_team_2018', to='SportsApp.nbateam')),
                ('home_team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='home_team_2018', to='SportsApp.nbateam')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('away_opp_blocks_pg', models.FloatField(default=0.0)),
                ('away_opp_plusMinus_pg', models.FloatField(default=0.0)),
                ('away_team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='away_team_2019', to='SportsApp.nbateam')),
                ('home_team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='home_team_2019', to='SportsApp.nbateam')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('away_opp_blocks_pg', models.FloatField(default=0.0)),
                ('away_opp_plusMinus_pg', models.FloatField(default=0.0)),
                ('away_team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='away_team_2020', to='SportsApp.nbateam')),
                ('home_team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='home_team_2020', to='SportsApp.nbateam')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('away_opp_blocks_pg', models.FloatField(default=0.0)),
                ('away_opp_plusMinus_pg', models.FloatField(default=0.0)),
                ('away_team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='away_team_2021', to='SportsApp.nbateam')),
                ('home_team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='home_team_2021', to='SportsApp.nbateam')),
            ],
            options={
                'abstract': False,
            },

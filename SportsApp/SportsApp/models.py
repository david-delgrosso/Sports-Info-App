...
class NBAPredictions2022(models.Model):
    ...
    home_points_eln             = models.FloatField(default=0.0)
    away_points_eln             = models.FloatField(default=0.0)
    home_points_eln_cum_me      = models.FloatField(default=0.0)
    away_points_eln_cum_me      = models.FloatField(default=0.0)
    home_points_eln_cum_rmse    = models.FloatField(default=0.0)
    away_points_eln_cum_rmse    = models.FloatField(default=0.0)
